# -*- coding: utf-8 -*-
"""
Created on Mon Dec 13 08:31:38 2021

@author: DELL
"""

# matlotlib kütüphanesi
...
plt.plot(setosa.Id , setosa.PetalLengthCm, color = "green" ,label = "setosa")
...
plt.show()
#%%
df1.plot(grid= True, linestyle = ":", alpha= 0.9, subplots= True)
plt.show()
